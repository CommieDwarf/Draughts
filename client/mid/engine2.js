...
var Engine = /** @class */ (function () {
    function Engine() {
        this.playerSide = config_1.preset.playerSide;
        this.whiteSide = config_1.preset.whiteSide;
        this.chessboard = [];
        this.turn = config_1.preset.turn == "black" ? "black" : "white";
    ...
    Engine.prototype.startNewGame = function () {
        this.chessboard = (0, createChessboard_1.default)();
        return this.chessboard;
    };
    Engine.prototype.makeChessboardInteractive = function (chessboard) {
        var _this = this;
                ...
                if (event.target instanceof Element) {
                    ...
                    if (square) {
                        if (square.getAttribute("id")) {
                            var squareId = square.getAttribute("id");
                            if (squareId) {
                                _this.performAction(parseInt(squareId), _this.chessboard);
                            }
                        }
                    }
                    else {
    ...
    Engine.prototype.performAction = function (clickedId, chessboard) {
        ...
        var movesWhite = this.getAllMoves(chessboard, 'white', this.playerSide);
        var movesBlack = this.getAllMoves(chessboard, 'black', this.playerSide);
        if (movesWhite.length == 0) {
            this.winner = "black";
        }
        else if (movesBlack.length == 0) {
            this.winner = "white";
        }
    };
    /////////////////////////////////////////////////
    ...
    Engine.prototype.getRegularMoves = function (selected, chessboard, turn, playerSide) {
        ...
        if (this.whiteSide == "bot" && turn == "white") {
