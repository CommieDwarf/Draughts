...
function createChessboard() {
    ...
    chessboard = addStartingPieces(chessboard, config_1.gameMode);
    return chessboard;
}
...
function addStartingPieces(chessboard, gameMode) {
    for (var i = 0; i < 64; i++) {
        if (chessboard[i]["square"] == "black") {
            if (config_1.preset.whitePieces.includes(i)) {
                addPiece(i, "white", chessboard);
            }
            else if (config_1.preset.blackPieces.includes(i)) {
